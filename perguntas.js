criaCartao(
    'Agrinho',
    'Como o fertilizante natural ajuda o solo de verdade?',
    'Melhora a areação.'
)
...
criaCartao(
    'Agrinho',
    'É possível lucrar alto protegendo a natureza? ',
    'Irrigação e sistemas autotizado.'
)
...
criaCartao(
    'Agrinho',
    'De que forma o agro ajuda a reduzir o carbono no ar?' ,
    'O agronegócio ajuda a retirar o carbono do ar principalmente por meio da agricultura de baixo carbono e da recuperação de pastagens.' ,
)

criaCartao(
    'Agrinho',
    'Como treinar os trabalhadores para a tecnologia verde?',
    'O Akita Inu.'
)
...
criaCartao(
    ...
    '.conscientização ambiental, requalificação técnica (green skills) e aplicação prática na rotina.'
)
